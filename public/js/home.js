document.addEventListener('DOMContentLoaded', function () {
        ...
        attachClickEvent('btnIslamiBankingMenu', islamiBankingPDFLink, commonCloseNav);
        ...
        const btnALAccountDPSInstalmentDetails = document.getElementById('btnALAccountDPSInstalmentDetails');
        ...
        async function handleALAccountDPSInstalmentDetails() {
            ...
            try {
                ...
                Swal.fire({
                    title: (locale === 'en') ? "Instalment Details" : "ইনস্টলমেন্ট ডিটেইলস",
        ...
        const btnCASAMiniStatement = document.getElementById('btnCASAMiniStatement');
    ...
    <div class="mini-statement-option" style="width: 100%">
        <label for="mini-statement-${statement.tran_serial}">
            <div class="mini-statement-details">
                ...
                Swal.fire({
                    title: `<h3 class="mini-statement-title"> ${(locale === 'en') ? "Mini Statement" : "মিনি স্টেটমেন্ট"}</h3>`,
                    html: `
